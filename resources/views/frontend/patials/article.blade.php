                ...
                <div class="cryptos-prices-table">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>01</span>
                            <img src="{{ asset('frontend/img/bg-img/bitcoin.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>02</span>
                            <img src="{{ asset('frontend/img/bg-img/ethereum.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>03</span>
                            <img src="{{ asset('frontend/img/bg-img/bitcoin-cash.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>04</span>
                            <img src="{{ asset('frontend/img/bg-img/ripple.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>05</span>
                            <img src="{{ asset('frontend/img/bg-img/litecoin.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>06</span>
                            <img src="{{ asset('frontend/img/bg-img/cardano.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>07</span>
                            <img src="{{ asset('frontend/img/bg-img/nem.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>08</span>
                            <img src="{{ asset('frontend/img/bg-img/neo.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>09</span>
                            <img src="{{ asset('frontend/img/bg-img/stellar.png') }}" alt="">
                    ...
                    <div class="single-price-table d-flex align-items-center justify-content-between">
                        <div class="p-content d-flex align-items-center">
                            <span>10</span>
                            <img src="{{ asset('frontend/img/bg-img/iota.png') }}" alt="">
