                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15b" align="left">
                                                                <h2>Welcome to the Trading Simulation website</h2>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-image" align="center">
                                                                <a target="_blank"> <img class="adapt-img"
                                                                                         src="https://wabbh.stripocdn.email/content/guids/CABINET_f9be1abc0ccb860d0eb866b0657ab992/images/24941558191457020.png"
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p20t" align="left">
                                                                <center><p>ระบบขายหุ้นอัตโนมัติ
                                                                        ได้ทำรายการของท่านไปเมื่อเวลา {{ \Carbon\Carbon::now('Asia/Bangkok') }}</p>
                                                                </center>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="esd-block-button es-p10"> <span
                                                                        class="es-button-border">
                    <a href="http://trading.test" class="btn btn-success" target="_blank">View this site.</a>
                </span></td>
                                                        </tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p10b" align="center">
                                                                <p>© 2019 Trading Simulation website</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
